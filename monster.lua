...
function createMonster(world,id,x,y,name)
  ...
  s.anims={
    ...
    walk={
      up        = anim8.newAnimation(s.grid('1-15',2),0.03),
      down      = anim8.newAnimation(s.grid('1-15',2),0.03),
      right     = anim8.newAnimation(s.grid('1-15',2),0.03),
      left      = anim8.newAnimation(s.grid('1-15',2),0.03),
      upleft    = anim8.newAnimation(s.grid('1-15',2),0.03),
      upright   = anim8.newAnimation(s.grid('1-15',2),0.03),
      downright = anim8.newAnimation(s.grid('1-15',2),0.03),
      downleft  = anim8.newAnimation(s.grid('1-15',2),0.03),
    },
    hit={
      up        = anim8.newAnimation(s.grid('1-8',3),0.11,function() s.animType="idle" end),
      down      = anim8.newAnimation(s.grid('1-8',3),0.11,function() s.animType="idle" end),
      right     = anim8.newAnimation(s.grid('1-8',3),0.11,function() s.animType="idle" end),
      left      = anim8.newAnimation(s.grid('1-8',3),0.11,function() s.animType="idle" end),
      upleft    = anim8.newAnimation(s.grid('1-8',3),0.11,function() s.animType="idle" end),
      upright   = anim8.newAnimation(s.grid('1-8',3),0.11,function() s.animType="idle" end),
      downright = anim8.newAnimation(s.grid('1-8',3),0.11,function() s.animType="idle" end),
      downleft  = anim8.newAnimation(s.grid('1-8',3),0.11,function() s.animType="idle" end),
    },
  }
